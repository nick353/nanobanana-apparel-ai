  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        '2xl': ['24px', { lineHeight: '34px', letterSpacing: '-0.02em', fontWeight: '600' }],
        '3xl': ['30px', { lineHeight: '40px', letterSpacing: '-0.02em', fontWeight: '700' }],
        '4xl': ['36px', { lineHeight: '44px', letterSpacing: '-0.03em', fontWeight: '700' }],
        '5xl': ['48px', { lineHeight: '56px', letterSpacing: '-0.03em', fontWeight: '700' }],
      },
      boxShadow: {
