...
const WorkflowGuidePanel = ({ definition, locale }) => {
  ...
  return (
    <aside className="rounded-16 border border-muted-teal/20 bg-muted-teal-light px-20 py-20 shadow-level-1 space-y-12">
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-muted-teal">
          Tips
        </p>
        <h3 className="text-base font-semibold text-charcoal mt-6">
