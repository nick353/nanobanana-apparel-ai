...
const SettingsModal = ({ isOpen, onClose, onSave, baseUrl }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-charcoal/60 px-16 fade-in"
      role="dialog"
      aria-modal="true"
      onClick={onClose}
    >
      <div
        className="glass-panel w-full max-w-lg p-32 shadow-level-4"
      ...
      >
        <div className="flex items-start justify-between mb-24">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex items-center justify-center w-32 h-32 rounded-8 bg-very-light-gray text-medium-gray hover:bg-light-gray hover:text-charcoal active:scale-98 transition-all duration-150"
